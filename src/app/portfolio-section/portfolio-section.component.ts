...
export class PortfolioSectionComponent {
  ...
  projects = [
    { portfolio: 'Join', tools: ['HTML', 'CSS', 'JavaScript'], description: ['Task manager inspired by the Kanban System. Create and organize tasks using drag and drop functions, assign users and categories. '] },
  ...
  onDivClick(i: number) {
    ...
    this.isVisible = true;
    console.log('Elterkomponente' + this.isVisible);
    this.selectedIndex = i;
  }

  visibilityChange(newVisibility: boolean) {
    console.log('Elternkomponente: Sichtbarkeit aktualisiert:', newVisibility);
